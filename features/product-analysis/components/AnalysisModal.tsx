...
export function AnalysisModal({ itemId, onClose }: { itemId: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-start justify-center overflow-y-auto p-4 md:p-8">
      <div className="bg-card rounded-2xl shadow-2xl w-full max-w-5xl relative animate-in fade-in slide-in-from-bottom-4 duration-300">
        {/* Header */}
        <div className="flex items-center justify-between border-b px-5 py-4 sticky top-0 bg-card rounded-t-2xl z-10">
